...
exports.getReview = asyncHandler(async (req, res, next) => {
    ...
    if (! review) {
        return next(new ErrorResponse(`No review found with the id of ${
            req.params.id
        }`, 404));
    }
...
exports.addReview = asyncHandler(async (req, res, next) => {
    ...
    if (! bootcamp) {
        return next(new ErrorResponse(`No bootcamp with the id of ${
...
exports.updateReview = asyncHandler(async (req, res, next) => {
    ...
    if (! review) {
        return next(new ErrorResponse(`No review with the id of ${
            req.params.id
        }`, 404));
    }
