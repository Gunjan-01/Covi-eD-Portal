...
const BootcampSchema = new mongoose.Schema({
    ...
    description: {
        type: String,
        required: [
            true, 'Please add description'
        ],
        maxlength: [500, 'not more than 500 characters']
    },
    website: {
        type: String,
        match: [/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)/, 'please add valid url with HTTP OR HTTPS',]
    },
    // phone:{
    //     type : Number,
